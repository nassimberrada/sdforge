...
def main():
    """
    Showcases the library of available SDF primitive shapes.

    This example demonstrates the creation and placement of various primitives,
    including `plane`, `cone`, `line`, `octahedron`, `hex_prism`, `ellipsoid`,
    `pyramid`, `round_cone`, and `box_frame`.
    """
    # A ground plane
    ...
    nut -= cylinder(0.2).orient(Z)

    # An ellipsoid "stone"
    stone = ellipsoid(x=0.8, y=0.4, z=0.5).translate(Y * 0.4 + X * 3.5)
