...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 30px"> <img src="./assets/hello_forge.png" width="80%"> </div>
</div>
...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 30px"> <img src="./assets/hot_reloading.png" width="80%"></div>
</div>
...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 30px"> <img src="./assets/primitives_operations.png" width="80%"> </div>
</div>
...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 20px"> <img src="./assets/transformations_shaping.png" width="80%"> </div>
</div>
...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 20px"> <img src="./assets/materials.png" width="80%"> </div>
</div>
...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 20px"> <img src="./assets/camera_lighting.png" width="80%"> </div>
</div>
...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 20px"> <img src="./assets/interactive_parameters.png" width="80%"> </div>
</div>
...
<div style="flex:1; min-width:100px; text-align:center; padding-bottom: 20px"> <img src="./assets/custom_glsl.png" width="80%"> </div>
</div>
