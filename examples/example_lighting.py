...
def main():
    """
    This example demonstrates scene lighting controls.
    The `main` function can return a tuple containing the sdf object,
    a camera object, and a lighting object.
    """
    ...
    # --- Light ---
    # You can define lighting and animate its properties using GLSL expressions.
    ...
    # lighting = Light(position=(4, 4, -3), shadow_softness=32.0, ambient_strength=0.2)
    ...
    # The order of camera and lighting objects in the returned tuple does not matter for hot-reloading.
